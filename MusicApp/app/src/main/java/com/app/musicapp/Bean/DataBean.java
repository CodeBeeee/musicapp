...
public class DataBean {
    ...
    public static List<DataBean> getTestData() {
        ...
        list.add(new DataBean(R.drawable.m2, "相信自己,你努力的样子真的很美", 2));
        list.add(new DataBean(R.drawable.m1, "极致简约,梦幻小屋", 3));
        list.add(new DataBean(R.drawable.m2, "超级卖梦人", 1));
        list.add(new DataBean(R.drawable.m4, "夏季新搭配", 2));
        list.add(new DataBean(R.drawable.m3, "绝美风格搭配", 1));
        list.add(new DataBean(R.drawable.m2, "微微一笑 很倾城", 3));
        return list;
    }
    public static List<DataBean> getTestData2() {
        List<DataBean> list = new ArrayList<>();
        list.add(new DataBean(R.drawable.m1, "相信自己,你努力的样子真的很美", 1));
        list.add(new DataBean(R.drawable.m2, "听风.赏雨", 3));
        list.add(new DataBean(R.drawable.m3, "迪丽热巴.迪力木拉提", 2));
        list.add(new DataBean(R.drawable.m4, "爱美.人间有之", 3));
        list.add(new DataBean(R.drawable.m1, "洋洋洋.气质篇", 1));
        list.add(new DataBean(R.drawable.m2, "生活的态度", 2));
        return list;
    }
