                ...
                <el-header>
                    ...
                    <el-input placeholder="请输入内容" v-model="searchinput" class="input-with-select" style="margin-top:30px;height:20px" >
                         <el-select v-model="select" slot="prepend" placeholder="请选择">
                              <el-option label="音乐名称" value="songname" style="width:100px;"></el-option>
                            <el-option label="音乐编号" value="songid" style="width:100px;"></el-option>
                        </el-select>
...
import {getMusicPlay,getSearchMusicPlay,addProblem,getProblem,getZhangjie,delBook,addZhangjie,addBookImg,findUserInfo,getUserCount,getUserSearch,delUser,updateUser,getPartStudent,delStudent,getPartBook} from '../../api/index';
...
export default {
    ...
    methods:{
        ...
        findMsg(){
            ...
            getMusicPlay(this.formdata).then(res=>{
                console.log(res);
                this.tableData = res;
                this.imgurlData = [];
                for(var k=0;k<this.tableData.length;k++){
                    if(this.tableData[k].songimg!=null){
                        console.log(this.tableData[k].songimg);
                        this.imgurlData[k] = this.tableData[k].songimg;
                    }else{
        ...
        userSearch(){
            ...
            getSearchMusicPlay(this.searchform).then(res=>{
                this.tableData = res;
